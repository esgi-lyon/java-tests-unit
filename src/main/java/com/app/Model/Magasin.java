...
public class Magasin extends AbstractEntity {
    ...
    private Set<Service> availableArticles = new HashSet<>();
    ...
    public Set<Service> getAvailableArticles() {
        return availableArticles;
    }

    public void setAvailableArticles(Set<Service> availableArticles) {
        this.availableArticles = availableArticles;
    }

    public void addArticle(Service service) {
        this.availableArticles.add(service);
    }
    ...
    protected String showAvailableArticles() {
        ...
        for (Service p: getAvailableArticles()) {
